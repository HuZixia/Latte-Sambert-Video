...
def main(args):
    ...
    for prompt in args.text_prompt:
        ...
        try:
            imageio.mimwrite(args.save_img_path + '_' + str(i) + '_' + prompt.replace(' ', '_') + '_%04d' % args.run_time + 'webv-imageio.mp4', videos[0], fps=8, quality=9) # highest quality is 10, lowest is 0
            i = i +1
        except:
